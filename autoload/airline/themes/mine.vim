...
function! airline#themes#mine#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  ...
  let g:airline#themes#mine#palette.inactive = airline#themes#generate_color_map(
  ...
  let g:airline#themes#mine#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#mine#palette.normal.airline_error = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#mine#palette.normal.airline_term = [
        \ s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]]
  ...
  let g:airline#themes#mine#palette.normal_modified.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.normal_modified.airline_term =
        \ g:airline#themes#mine#palette.normal.airline_term

  let g:airline#themes#mine#palette.terminal = airline#themes#generate_color_map(
        \ [s:T1[0].g, s:T1[1].g, s:T1[0].t, s:T1[1].t, s:T1[2]],
        \ [s:T2[0].g, s:T2[1].g, s:T2[0].t, s:T2[1].t, s:T2[2]],
        \ [s:T3[0].g, s:T3[1].g, s:T3[0].t, s:T3[1].t, s:T3[2]])

  let g:airline#themes#mine#palette.terminal.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.terminal.airline_term =
        \ g:airline#themes#mine#palette.normal.airline_term

  let g:airline#themes#mine#palette.terminal_modified = {
        \ 'airline_c': [s:TM[0].g, s:TM[1].g,
        \ s:TM[0].t, s:TM[1].t, s:TM[2]]}

  let g:airline#themes#mine#palette.terminal_modified.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.terminal_modified.airline_term =
        \ g:airline#themes#mine#palette.normal_modified.airline_term

  let g:airline#themes#mine#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#mine#palette.insert.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning
  ...
  let g:airline#themes#mine#palette.insert_modified.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#mine#palette.visual.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.visual.airline_term =
        \ g:airline#themes#mine#palette.normal.airline_term
  ...
  let g:airline#themes#mine#palette.visual_modified.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.visual_modified.airline_term =
        \ g:airline#themes#mine#palette.normal_modified.airline_term

  let g:airline#themes#mine#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#mine#palette.replace.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#mine#palette.replace_modified.airline_warning =
        \ g:airline#themes#mine#palette.normal.airline_warning

  let g:airline#themes#mine#palette.tabline = {}

  let g:airline#themes#mine#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#mine#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#mine#refresh()
